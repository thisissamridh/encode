...
"use strict";Object.defineProperty(exports,"__esModule",{value:!0}),Object.defineProperty(exports,"Observable",{enumerable:!0,get:function(){return a.default}}),Object.defineProperty(exports,"Subject",{enumerable:!0,get:function(){return o.default}}),Object.defineProperty(exports,"filter",{enumerable:!0,get:function(){return e.default}}),Object.defineProperty(exports,"flatMap",{enumerable:!0,get:function(){return r.default}}),Object.defineProperty(exports,"interval",{enumerable:!0,get:function(){return t.default}}),Object.defineProperty(exports,"map",{enumerable:!0,get:function(){return u.default}}),Object.defineProperty(exports,"merge",{enumerable:!0,get:function(){return n.default}}),Object.defineProperty(exports,"multicast",{enumerable:!0,get:function(){return i.default}}),Object.defineProperty(exports,"scan",{enumerable:!0,get:function(){return f.default}}),Object.defineProperty(exports,"unsubscribe",{enumerable:!0,get:function(){return l.default}});var e=b(require("./filter")),r=b(require("./flatMap")),t=b(require("./interval")),u=b(require("./map")),n=b(require("./merge")),i=b(require("./multicast")),a=b(require("./observable")),f=b(require("./scan")),o=b(require("./subject")),l=b(require("./unsubscribe"));function b(e){return e&&e.__esModule?e:{default:e}}
...
"use strict";Object.defineProperty(exports,"__esModule",{value:!0}),exports.Subject=exports.Observable=void 0;const e=require("observable-fns");Object.defineProperty(exports,"Observable",{enumerable:!0,get:function(){return e.Observable}});const r=Symbol("observers");class t extends e.Observable{constructor(){super(e=>{this[r]=[...this[r]||[],e];return()=>{this[r]=this[r].filter(r=>r!==e)}}),this[r]=[]}complete(){this[r].forEach(e=>e.complete())}error(e){this[r].forEach(r=>r.error(e))}next(e){this[r].forEach(r=>r.next(e))}}exports.Subject=t;
},{"observable-fns":"qNpQ"}],"UXXB":[function(require,module,exports) {
module.exports=require("./dist/observable");
},{"./dist/observable":"Glkj"}],"vEfl":[function(require,module,exports) {
"use strict";module.exports=(e=>!!e&&("symbol"==typeof Symbol.observable&&"function"==typeof e[Symbol.observable]?e===e[Symbol.observable]():"function"==typeof e["@@observable"]&&e===e["@@observable"]()));
},{}],"MHT7":[function(require,module,exports) {
...
},{}],"qO8u":[function(require,module,exports) {
"use strict";Object.defineProperty(exports,"__esModule",{value:!0}),exports.createLogger=void 0;class e{constructor(e){let o=arguments.length>1&&void 0!==arguments[1]?arguments[1]:console.log;this.prefix=e,this.logger=o}log(){for(var e=arguments.length,o=new Array(e),r=0;r<e;r++)o[r]=arguments[r];this.logger("".concat(this.prefix,":"),...o)}}function o(o){if(o){const r=new e(o,console.log);return function(){return r.log(...arguments)}}return console.log}exports.createLogger=o;
...
},{"./common":"PId8","process":"rH1J"}],"QUPD":[function(require,module,exports) {
"use strict";Object.defineProperty(exports,"__esModule",{value:!0}),exports.isEnabled=exports.enableLogs=exports.setPostDebugLogHook=exports.setPreDebugLogHook=exports.createDebugLogger=void 0;const e=require("tslib"),o=(0,e.__importDefault)(require("debug"));let t,r;function n(e){for(var o=arguments.length,n=new Array(o>1?o-1:0),s=1;s<o;s++)n[s-1]=arguments[s];t&&t(...n),e(...n),r&&r(...n)}function s(e){const t=(0,o.default)(e);return function(){for(var e=arguments.length,o=new Array(e),r=0;r<e;r++)o[r]=arguments[r];return n(t,...o)}}function u(e){t=e}function g(e){r=e}function a(e){o.default.enable(e)}function i(e){return o.default.enabled(e)}exports.createDebugLogger=s,exports.setPreDebugLogHook=u,exports.setPostDebugLogHook=g,exports.enableLogs=a,exports.isEnabled=i;
},{"tslib":"xgwM","debug":"BYFN"}],"CoM9":[function(require,module,exports) {
"use strict";Object.defineProperty(exports,"__esModule",{value:!0});const e=require("tslib");(0,e.__exportStar)(require("./console"),exports),(0,e.__exportStar)(require("./debug"),exports);
},{"tslib":"xgwM","./console":"qO8u","./debug":"QUPD"}],"QAnv":[function(require,module,exports) {
...
},{"base64-js":"QAnv","ieee754":"O1Qa","isarray":"ZCp3","buffer":"VjIL"}],"ugze":[function(require,module,exports) {
var Buffer = require("buffer").Buffer;
var e=require("buffer").Buffer;Object.defineProperty(exports,"__esModule",{value:!0}),exports.Aes128=void 0;class t{constructor(e){this.wasm=e}encryptBufferCBC(t,l,n){const h=t.length,s=h%16!=0?16-h%16:0,g=e.alloc(s);0!=s&&g.fill(s);const a=e.concat([t,g]),r=this.wasm.call("bbmalloc",a.length+n.length+l.length+a.length);this.wasm.transferToHeap(a,r),this.wasm.transferToHeap(l,r+a.length),this.wasm.transferToHeap(n,r+a.length+l.length),this.wasm.call("aes__encrypt_buffer_cbc",r,r+a.length,r+a.length+l.length,a.length,r+a.length+l.length+n.length);const c=e.from(this.wasm.sliceMemory(r+a.length+n.length+l.length,r+a.length+n.length+l.length+a.length));return this.wasm.call("bbfree",r),c}decryptBufferCBC(t,l,n){const h=this.wasm.call("bbmalloc",t.length+n.length+l.length+t.length);this.wasm.transferToHeap(t,h),this.wasm.transferToHeap(l,h+t.length),this.wasm.transferToHeap(n,h+t.length+l.length),this.wasm.call("aes__decrypt_buffer_cbc",h,h+t.length,h+t.length+l.length,t.length,h+t.length+l.length+n.length);const s=e.from(this.wasm.sliceMemory(h+t.length+n.length+l.length,h+t.length+n.length+l.length+t.length));return this.wasm.call("bbfree",h),s}}exports.Aes128=t;
},{"buffer":"VjIL"}],"V0gI":[function(require,module,exports) {
var Buffer = require("buffer").Buffer;
var e=require("buffer").Buffer;Object.defineProperty(exports,"__esModule",{value:!0}),exports.Blake2s=void 0;class s{constructor(e){this.wasm=e}hashToField(s){const a=this.wasm.call("bbmalloc",s.length);return this.wasm.transferToHeap(s,a),this.wasm.call("blake2s_to_field",a,s.length,0),this.wasm.call("bbfree",a),e.from(this.wasm.sliceMemory(0,32))}}exports.Blake2s=s;
},{"buffer":"VjIL"}],"u5OK":[function(require,module,exports) {
var Buffer = require("buffer").Buffer;
var t=require("buffer").Buffer;function e(e){const r=t.from(e);r.reverse();const o=r.toString("hex");return 0===o.length?BigInt(0):BigInt("0x".concat(o))}function r(t){const e=t.toString("hex");return 0===e.length?BigInt(0):BigInt("0x".concat(e))}function o(e,r){const o=e.toString(16),n=t.from(o.padStart(2*r,"0").slice(0,2*r),"hex");return n.reverse(),n}function n(e,r){const o=e.toString(16);return t.from(o.padStart(2*r,"0").slice(0,2*r),"hex")}Object.defineProperty(exports,"__esModule",{value:!0}),exports.toBufferBE=exports.toBufferLE=exports.toBigIntBE=exports.toBigIntLE=void 0,exports.toBigIntLE=e,exports.toBigIntBE=r,exports.toBufferLE=o,exports.toBufferBE=n;
},{"buffer":"VjIL"}],"Ygzd":[function(require,module,exports) {
var Buffer = require("buffer").Buffer;
var e=require("buffer").Buffer;Object.defineProperty(exports,"__esModule",{value:!0}),exports.deserializeArrayFromVector=exports.serializeBufferArrayToVector=exports.deserializeField=exports.deserializeInt32=exports.deserializeUInt32=exports.deserializeBool=exports.deserializeBufferFromVector=exports.serializeDate=exports.deserializeBigInt=exports.serializeBigInt=exports.serializeBufferToVector=exports.numToUInt8=exports.numToInt32BE=exports.numToUInt32BE=exports.boolToByte=void 0;const t=require("../bigint_buffer");function r(t){const r=e.alloc(1);return r.writeUInt8(t?1:0),r}function o(t){let r=arguments.length>1&&void 0!==arguments[1]?arguments[1]:4;const o=e.alloc(r);return o.writeUInt32BE(t,r-4),o}function n(t){let r=arguments.length>1&&void 0!==arguments[1]?arguments[1]:4;const o=e.alloc(r);return o.writeInt32BE(t,r-4),o}function i(t){const r=e.alloc(1);return r.writeUInt8(t,0),r}function l(t){const r=e.alloc(4);return r.writeUInt32BE(t.length,0),e.concat([r,t])}function s(e){let r=arguments.length>1&&void 0!==arguments[1]?arguments[1]:32;return(0,t.toBufferBE)(e,r)}function a(e){let r=arguments.length>1&&void 0!==arguments[1]?arguments[1]:0,o=arguments.length>2&&void 0!==arguments[2]?arguments[2]:32;return{elem:(0,t.toBigIntBE)(e.slice(r,r+o)),adv:o}}function u(e){return s(BigInt(e.getTime()),8)}function c(e){let t=arguments.length>1&&void 0!==arguments[1]?arguments[1]:0;const r=4+e.readUInt32BE(t);return{elem:e.slice(t+4,t+r),adv:r}}function d(e){let t=arguments.length>1&&void 0!==arguments[1]?arguments[1]:0;return{elem:e.readUInt8(t),adv:1}}function f(e){let t=arguments.length>1&&void 0!==arguments[1]?arguments[1]:0;return{elem:e.readUInt32BE(t),adv:4}}function p(e){let t=arguments.length>1&&void 0!==arguments[1]?arguments[1]:0;return{elem:e.readInt32BE(t),adv:4}}function B(e){let t=arguments.length>1&&void 0!==arguments[1]?arguments[1]:0;return{elem:e.slice(t,t+32),adv:32}}function x(t){const r=e.alloc(4);return r.writeUInt32BE(t.length,0),e.concat([r,...t])}function I(e,t){let r=arguments.length>2&&void 0!==arguments[2]?arguments[2]:0,o=r;const n=t.readUInt32BE(o);o+=4;const i=new Array(n);for(let l=0;l<n;++l){const{elem:r,adv:n}=e(t,o);o+=n,i[l]=r}return{elem:i,adv:o-r}}exports.boolToByte=r,exports.numToUInt32BE=o,exports.numToInt32BE=n,exports.numToUInt8=i,exports.serializeBufferToVector=l,exports.serializeBigInt=s,exports.deserializeBigInt=a,exports.serializeDate=u,exports.deserializeBufferFromVector=c,exports.deserializeBool=d,exports.deserializeUInt32=f,exports.deserializeInt32=p,exports.deserializeField=B,exports.serializeBufferArrayToVector=x,exports.deserializeArrayFromVector=I;
},{"../bigint_buffer":"u5OK","buffer":"VjIL"}],"zYK9":[function(require,module,exports) {
"use strict";Object.defineProperty(exports,"__esModule",{value:!0}),exports.Deserializer=void 0;const e=require("./free_funcs");class t{constructor(e){let t=arguments.length>1&&void 0!==arguments[1]?arguments[1]:0;this.buf=e,this.offset=t}bool(){return!!this.exec(e.deserializeBool)}uInt32(){return this.exec(e.deserializeUInt32)}int32(){return this.exec(e.deserializeInt32)}bigInt(){let t=arguments.length>0&&void 0!==arguments[0]?arguments[0]:32;return this.exec((r,s)=>(0,e.deserializeBigInt)(r,s,t))}vector(){return this.exec(e.deserializeBufferFromVector)}buffer(e){const t=this.buf.slice(this.offset,this.offset+e);return this.offset+=e,t}string(){return this.vector().toString()}date(){return new Date(Number(this.bigInt(8)))}deserializeArray(t){return this.exec((r,s)=>(0,e.deserializeArrayFromVector)(t,r,s))}exec(e){const{elem:t,adv:r}=e(this.buf,this.offset);return this.offset+=r,t}getOffset(){return this.offset}}exports.Deserializer=t;
},{"./free_funcs":"Ygzd"}],"BYi7":[function(require,module,exports) {
var Buffer = require("buffer").Buffer;
var e=require("buffer").Buffer;Object.defineProperty(exports,"__esModule",{value:!0}),exports.Serializer=void 0;const r=require("."),t=require("./free_funcs");class u{constructor(){this.buf=[]}bool(e){this.buf.push((0,t.boolToByte)(e))}uInt32(e){this.buf.push((0,t.numToUInt32BE)(e))}int32(e){this.buf.push((0,t.numToInt32BE)(e))}bigInt(e){this.buf.push((0,t.serializeBigInt)(e))}vector(e){this.buf.push((0,t.serializeBufferToVector)(e))}buffer(e){this.buf.push(e)}string(r){this.vector(e.from(r))}date(e){this.buf.push((0,t.serializeDate)(e))}getBuffer(){return e.concat(this.buf)}serializeArray(e){this.buf.push((0,r.serializeBufferArrayToVector)(e.map(e=>e.toBuffer())))}}exports.Serializer=u;
},{".":"OyKl","./free_funcs":"Ygzd","buffer":"VjIL"}],"OyKl":[function(require,module,exports) {
"use strict";Object.defineProperty(exports,"__esModule",{value:!0});const e=require("tslib");(0,e.__exportStar)(require("./free_funcs"),exports),(0,e.__exportStar)(require("./deserializer"),exports),(0,e.__exportStar)(require("./serializer"),exports);
},{"tslib":"xgwM","./free_funcs":"Ygzd","./deserializer":"zYK9","./serializer":"BYi7"}],"rQF2":[function(require,module,exports) {
var Buffer = require("buffer").Buffer;
...
},{"../../serialize":"OyKl","buffer":"VjIL"}],"wMQ2":[function(require,module,exports) {
"use strict";Object.defineProperty(exports,"__esModule",{value:!0}),exports.PooledPedersen=void 0;const e=require("./single_pedersen");class o extends e.SinglePedersen{constructor(o,s){super(o),this.pool=[],this.pool=s.workers.map(s=>new e.SinglePedersen(o,s))}async init(){await Promise.all(this.pool.map(e=>e.init()))}async hashToTree(e){if(!(e=>e&&!(e&e-1))(e.length))throw new Error("PooledPedersen::hashValuesToTree can only handle powers of 2.");const o=Math.min(e.length/2,this.pool.length),s=this.pool.slice(0,Math.max(o,1)),t=e.length/s.length,l=(await Promise.all(s.map((o,s)=>o.hashToTree(e.slice(s*t,(s+1)*t))))).map(e=>{const o=[];for(let s=t,l=0;s>=1;l+=s,s/=2)o.push(e.slice(l,l+s));return o}),n=l[0];for(let r=1;r<l.length;++r)for(let e=0;e<l[r].length;++e)n[e]=[...n[e],...l[r][e]];for(;n[n.length-1].length>1;){const e=n[n.length-1],o=[];for(let s=0;s<e.length;s+=2)o[s/2]=this.pool[0].compress(e[s],e[s+1]);n.push(o)}return n.flat()}}exports.PooledPedersen=o;
},{"./single_pedersen":"rQF2"}],"BrH5":[function(require,module,exports) {
"use strict";Object.defineProperty(exports,"__esModule",{value:!0});const e=require("tslib");(0,e.__exportStar)(require("./pedersen"),exports),(0,e.__exportStar)(require("./pooled_pedersen"),exports),(0,e.__exportStar)(require("./single_pedersen"),exports);
},{"tslib":"xgwM","./pedersen":"Y6eJ","./pooled_pedersen":"wMQ2","./single_pedersen":"rQF2"}],"udfh":[function(require,module,exports) {
...
},{"tslib":"xgwM","fs":"Zcgp","detect-node":"pOFZ","util":"QcjV","events":"LMQS","../log":"CoM9","../crypto":"qzCF","../fifo":"DPt1","buffer":"VjIL"}],"xQvT":[function(require,module,exports) {
"use strict";function e(e,r){const i=e.deserialize.bind(e),a=e.serialize.bind(e);return{deserialize:e=>r.deserialize(e,i),serialize:e=>r.serialize(e,a)}}Object.defineProperty(exports,"__esModule",{value:!0}),exports.DefaultSerializer=void 0,exports.extendSerializer=e;const r={deserialize:e=>Object.assign(Error(e.message),{name:e.name,stack:e.stack}),serialize:e=>({__error_marker:"$$error",message:e.message,name:e.name,stack:e.stack})},i=e=>e&&"object"==typeof e&&"__error_marker"in e&&"$$error"===e.__error_marker,a={deserialize:e=>i(e)?r.deserialize(e):e,serialize:e=>e instanceof Error?r.serialize(e):e};exports.DefaultSerializer=a;
},{}],"CYV0":[function(require,module,exports) {
"use strict";Object.defineProperty(exports,"__esModule",{value:!0}),exports.deserialize=t,exports.registerSerializer=i,exports.serialize=s;var e=require("./serializers");let r=e.DefaultSerializer;function i(i){r=(0,e.extendSerializer)(r,i)}function t(e){return r.deserialize(e)}function s(e){return r.serialize(e)}
...
"use strict";Object.defineProperty(exports,"__esModule",{value:!0}),exports.Transfer=s,exports.isTransferDescriptor=t;var r=require("./symbols");function e(r){return!(!r||"object"!=typeof r)}function t(e){return e&&"object"==typeof e&&e[r.$transferable]}function s(t,s){if(!s){if(!e(t))throw Error();s=[t]}return{[r.$transferable]:!0,send:t,transferables:s}}
...
"use strict";Object.defineProperty(exports,"__esModule",{value:!0}),exports.BlobWorker=void 0,Object.defineProperty(exports,"Pool",{enumerable:!0,get:function(){return r.Pool}}),Object.defineProperty(exports,"Thread",{enumerable:!0,get:function(){return o.Thread}}),exports.Worker=void 0,Object.defineProperty(exports,"isWorkerRuntime",{enumerable:!0,get:function(){return e.isWorkerRuntime}}),Object.defineProperty(exports,"spawn",{enumerable:!0,get:function(){return t.spawn}});var e=require("./implementation"),r=require("./pool"),t=require("./spawn"),o=require("./thread");const n=(0,e.getWorkerImplementation)().blob;exports.BlobWorker=n;const i=(0,e.getWorkerImplementation)().default;exports.Worker=i;
...
"use strict";Object.defineProperty(exports,"__esModule",{value:!0});var e={registerSerializer:!0,expose:!0,DefaultSerializer:!0,Transfer:!0};Object.defineProperty(exports,"DefaultSerializer",{enumerable:!0,get:function(){return n.DefaultSerializer}}),Object.defineProperty(exports,"Transfer",{enumerable:!0,get:function(){return o.Transfer}}),Object.defineProperty(exports,"expose",{enumerable:!0,get:function(){return i.expose}}),Object.defineProperty(exports,"registerSerializer",{enumerable:!0,get:function(){return r.registerSerializer}});var r=require("./common"),t=require("./master/index");Object.keys(t).forEach(function(r){"default"!==r&&"__esModule"!==r&&(Object.prototype.hasOwnProperty.call(e,r)||r in exports&&exports[r]===t[r]||Object.defineProperty(exports,r,{enumerable:!0,get:function(){return t[r]}}))});var i=require("./worker/index"),n=require("./serializers"),o=require("./transferable");
},{"./common":"CYV0","./master/index":"kzMO","./worker/index":"qolJ","./serializers":"xQvT","./transferable":"QYzz"}],"FeCX":[function(require,module,exports) {
"use strict";Object.defineProperty(exports,"__esModule",{value:!0}),exports.destroyWorker=exports.createWorker=void 0;const e=require("threads"),r=require("../log");async function t(t,o,s){let a=arguments.length>3&&void 0!==arguments[3]?arguments[3]:3e5;const i=(0,r.createDebugLogger)("bb:wasm".concat(t?":"+t:"")),n=await(0,e.spawn)(new e.Worker("./worker.js"),{timeout:a});return n.logs().subscribe(i),await n.init(o,s),n}async function o(r){await e.Thread.terminate(r)}exports.createWorker=t,exports.destroyWorker=o;
},{"threads":"OFd8","../log":"CoM9"}],"szJY":[function(require,module,exports) {
"use strict";Object.defineProperty(exports,"__esModule",{value:!0}),exports.WorkerPool=void 0;const e=require("../log"),r=require("./worker_factory"),o=(0,e.createDebugLogger)("bb:worker_pool");class t{constructor(){this.workers=[]}static async new(e,r){const o=new t;return await o.init(e.module,r),o}async init(e,t){o("creating ".concat(t," workers..."));const s=(new Date).getTime();this.workers=await Promise.all(Array(t).fill(0).map((o,t)=>(0,r.createWorker)("".concat(t),e,0===t?1e4:256))),o("created workers: ".concat((new Date).getTime()-s,"ms"))}async destroy(){await Promise.all(this.workers.map(r.destroyWorker))}}exports.WorkerPool=t;
},{"../log":"CoM9","./worker_factory":"FeCX"}],"QCba":[function(require,module,exports) {
var __dirname = "/mnt/user-data/kev/tmp/aztec-connect/barretenberg.js/src/wasm";
var Buffer = require("buffer").Buffer;
var e="/mnt/user-data/kev/tmp/aztec-connect/barretenberg.js/src/wasm",r=require("buffer").Buffer;Object.defineProperty(exports,"__esModule",{value:!0}),exports.fetchCode=exports.BarretenbergWorker=void 0;const t=require("tslib"),a=require("fs"),o=(0,t.__importDefault)(require("detect-node")),i=require("util"),n=require("events");(0,t.__exportStar)(require("./barretenberg_wasm"),exports),(0,t.__exportStar)(require("./worker_pool"),exports),(0,t.__exportStar)(require("./worker_factory"),exports);var u=require("./worker");async function s(){if(o.default)return await(0,i.promisify)(a.readFile)(e+"/barretenberg.wasm");{const e=await fetch("/barretenberg.wasm");return r.from(await e.arrayBuffer())}}Object.defineProperty(exports,"BarretenbergWorker",{enumerable:!0,get:function(){return u.BarretenbergWorker}}),n.EventEmitter.defaultMaxListeners=30,exports.fetchCode=s;
...
"use strict";Object.defineProperty(exports,"__esModule",{value:!0});const e=require("threads/observable"),r=require("threads/worker"),a=require(".");let s;const n=new e.Subject,t={async init(e,r){(s=new a.BarretenbergWasm).on("log",e=>n.next(e)),await s.init(e,r)},async transferToHeap(e,r){s.transferToHeap(e,r)},async sliceMemory(e,a){const n=s.sliceMemory(e,a);return(0,r.Transfer)(n,[n.buffer])},async call(e){for(var r=arguments.length,a=new Array(r>1?r-1:0),n=1;n<r;n++)a[n-1]=arguments[n];return s.call(e,...a)},memSize:async()=>s.memSize(),logs:()=>e.Observable.from(n),async acquire(){await s.acquire()},async release(){s.release()}};(0,r.expose)(t);
